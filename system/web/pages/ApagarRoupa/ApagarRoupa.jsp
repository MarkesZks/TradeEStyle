        ...
        <div class="navbar navbar-dark bg-dark shadow-sm">
            <div class="container">
                ...
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item"><a href="./ApagarRoupa/ApagarRoupa.jsp" class="btn btn-success">Apagar</a></li>
                </ul>     
            ...
            <div class="row justify-content-center align-items-center">
                ...
                <form name="frmApagarRoupa" method="post" action="ActionApagarRoupa.jsp" class="needs-validation">
                    ...
                    <div class="row justify-content-center align-items-center">
                        ...
                        <button onclick="document.location = 'ActionApagarRoupa.jsp'"  class="w-25 btn btn-success btn-lg " type="submit" value="Apagar">Apagar</button>
                    </div>
                </form>
            </div>
        </main>
