  ...
  <main>
      ...
      <div class="row justify-content-center align-items-center">
        ...
        <form class="needs-validation" novalidate>
          <div class="row g-3">
            ...
            <div class="col-sm-6">
              <label for="lastName" class="form-label"><h6>Sobrenome</h6></label>
            ...
            <div class="col-6">
              ...
              <div class="input-group has-validation">
                ...
                <input type="text" class="form-control" id="username" placeholder="fulanodetal123" required>
              <div class="invalid-feedback">
            ...
            <div class="col-6">
              ...
              <input type="text" class="form-control" id="address" placeholder="Rua Aurora">
            </div>
	...
	<option value="Zâmbia">Zâmbia</option>
        ...
        <option value="TO">Tocantins</option>
          ...
          <div class="row justify-content-center align-items-center">
              <button class="w-50 btn btn-primary btn-lg " type="submit">Cadastrar usuário</button>
          </div>
