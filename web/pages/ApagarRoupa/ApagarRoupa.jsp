        ...
        <div class="navbar navbar-dark bg-dark shadow-sm">
            <div class="container">
                ...
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item"><a href="./ApagarRoupa/ApagarRoupa.jsp" class="nav-link active">Apagar Roupa</a></li>
                </ul>     
    ...
    <div class="container">
        <main>
            <div class="py-5 text-center">
                <h2>Apagar roupa</h2>
                <p class="lead">Apague aqui o cadastro da sua roupa<p>
            </div>

            <div class="row justify-content-center align-items-center">
                <h4 class="mb-3">Informe o id da roupa a ser apagada</h4>
                     <!-- Form informando o id da roupa que deseja apagar -->

                <form name="frmApagarRoupa" method="post" action="ActionApagarRoupa.jsp" class="needs-validation">
                    <div class="row g-3">
                        <div class="col-sm-12">
                    ...
                    <div class="row justify-content-center align-items-center">
                        <a href=""></a>
                                 <!-- Botão levara para o action -->
                        <button onclick="document.location = 'ActionApagarRoupa.jsp'"  class="w-25 btn btn-primary btn-lg " type="submit" value="Apagar">Apagar roupa</button>
                    </div>
                </form>
            </div>
        </main>
