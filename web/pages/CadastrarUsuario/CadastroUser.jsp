...
<form name="FormUser" method="post" action="actionUser.jsp" class="needs-validation" novalidate>
          <div class="row g-3">
            <div class="col-sm-6">
                <label for="firstName" class="form-label"><h6>Nome</h6></label>
            ...
            <div class="col-sm-6">
              <label for="lastName" class="form-label"><h6>Senha</h6></label>
              <input name="senha" type="text" class="form-control" id="password"  required>
              <div class="invalid-feedback">
            ...
            <div class="col-6">
              <label for="" class="form-label"><h6>Telefone</h6> </label>
            ...
            <div class="col-6">
              <label for="address2" class="form-label"><h6>Endereço <span class="text-body-secondary"> (Opicional)</span></h6></span></label>
              <input name="endereco" type="text" class="form-control" id="address" placeholder="Rua Aurora">
            </div>

            <div class="col-md-6">
              <label for="country" class="form-label"><h6>País</h6></label>
